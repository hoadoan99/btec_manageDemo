            ...
            <div class="col-sm-12">
                ...
                <div id="hide-table">
                    ...
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="example1_info">
                        <thead>
                            <tr role="row">
                                <th class="col-lg-1 sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="#: activate to sort column descending" style="width: 71px;">#</th>

                                <th class="col-lg-2 sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Class: activate to sort column ascending" style="width: 160px;">Class</th>

                                <th class="col-lg-2 sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Class Numeric: activate to sort column ascending" style="width: 160px;">Class Numeric</th>

                                <th class="col-lg-3 sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Teacher Name: activate to sort column ascending" style="width: 249px;">Training Name</th>

                                <th class="col-lg-2 sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Note: activate to sort column ascending" style="width: 160px;">Note</th>

                                <th class="col-lg-2 sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Action: activate to sort column ascending" style="width: 160px;">Action</th></tr>
                        </thead>
                        <tbody>
                             <tr role="row" class="odd">
                                    ...
                                    <td data-title="Note">
                                      ...
                                      <td data-title="Action">
                                        ...
                                        <a href="#" onclick="return confirm('you are about to delete a record. This cannot be undone. are you sure?')" class="btn btn-danger btn-xs mrg" data-placement="top" data-toggle="tooltip" data-original-title="Delete">Deleted</a>
                                    </td>
                                </tr>
